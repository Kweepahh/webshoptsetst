...
import org.example.zaalschoenenwebshop.config.JWTUtil;
import org.example.zaalschoenenwebshop.dao.UserRepository;
import org.example.zaalschoenenwebshop.dto.AuthenticationDTO;
import org.example.zaalschoenenwebshop.dto.LoginResponse;
import org.example.zaalschoenenwebshop.models.CustomUser;
import org.example.zaalschoenenwebshop.services.CredentialValidator;
...
public class AuthController {
    ...
    public ResponseEntity<LoginResponse> register(@RequestBody AuthenticationDTO authenticationDTO) {
        ...
        LoginResponse loginResponse = new LoginResponse(registerdCustomUser.getEmail(), token, false);
    ...
    public ResponseEntity<LoginResponse> login(@RequestBody AuthenticationDTO body) {
        try {
            ...
            LoginResponse loginResponse = new LoginResponse(customUser.getEmail(), token, isAdmin);
